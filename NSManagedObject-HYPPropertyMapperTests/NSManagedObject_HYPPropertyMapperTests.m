...
- (void)testReplacementIdentifier
{
    ...
    XCTAssertEqualObjects([testString hyp_replacementIdentifier:@""], @"FirstName");

    testString = @"id";

    XCTAssertEqualObjects([testString hyp_replacementIdentifier:@""], @"ID");

    testString = @"user_id";

    XCTAssertEqualObjects([testString hyp_replacementIdentifier:@""], @"UserID");
}
